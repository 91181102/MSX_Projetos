...
set PROJECT_DIR="C:\git\msx_projetos\projeto1\src\"
set OUTPUT_BAS="C:\git\msx_projetos\projeto1\bin\main.bas"
set ROM_PATH="C:\git\msx_projetos\projeto1\bin\main.rom"
