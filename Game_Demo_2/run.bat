...
set PROJECT_DIR="C:\git\msx_projetos\Game_Demo_2\src\"
set OUTPUT_BAS="C:\git\msx_projetos\Game_Demo_2\bin\gd2.bas"
set ROM_PATH="C:\git\msx_projetos\Game_Demo_2\bin\gd2[ASCII8].rom"
::set ROM_PATH="C:\git\msx_projetos\Game_Demo_2\src\gd2.rom"
