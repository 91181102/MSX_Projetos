...
set PROJECT_DIR="C:\git\msx_projetos\projeto1\"
set OUTPUT_BAS="C:\git\msx_projetos\projeto1\main_file\main.bas"
set ROM_PATH="C:\git\msx_projetos\projeto1\main_file\main.rom"
